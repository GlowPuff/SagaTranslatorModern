...
{
	/// <summary>
	/// Interaction logic for CampaignInfoPanel.xaml
	/// </summary>
	public partial class CampaignInfoPanel : PanelBase
	{
		private SourceData _sourceData;

		public CampaignInfoPanel( SourceData data )
		{
			InitializeComponent();

			commonPanelData = new CommonPanelData()
			{
				windowTitle = "Saga Translator [Campaign Info] - NOT SAVED",
				infoText = $"Editing {data.fileName}",
				showLanguageSelector = false,
				fileName = data.fileName,
				translationName = "Campaign Info"
			};
